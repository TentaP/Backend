...
class University(models.Model):
    ...
    courses = models.ForeignKey('Course', related_name='University', on_delete=models.CASCADE)

class Course(models.Model):
    course_name = models.CharField(max_length=200, unique=True)
    files = models.ForeignKey('File', related_name='Course', on_delete=models.CASCADE, blank=True, null=True)
